    ...
    <div id="carouselExampleControls" class="carousel slide w-100" data-ride="carousel" style="background-color: rgb(48, 48, 48);">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="slider1.webp" class="d-block w-75 rounded mx-auto p-3 rounded" alt="...">
          </div>
          <div class="carousel-item">
            <img src="slider2.webp" class="d-block w-75 rounded mx-auto p-3 rounded" alt="...">
          </div>
          <div class="carousel-item">
            <img src="slider3.webp" class="d-block w-75 rounded mx-auto p-3 rounded" alt="...">
          </div>
        </div>
    ...
    <div class="p-3" style="background-color: rgb(180, 179, 179);">
        ...
        <div class="row m-3 d-flex justify-content-center">
            <div class="card m-2" style="width: 18rem;">
                <img src="pic1.jpg" class="rounded m-3" alt="Book">
                <div class="card-body">
